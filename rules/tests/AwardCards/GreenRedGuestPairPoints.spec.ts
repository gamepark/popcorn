...
import { GreenRedGuestPairPoints } from '../../src/material/AwardCards/GreenRedGuestPairPoints'
...
describe('GreenRedGuestPairPoints tests', () => {
  test.for([
    ...
    'Given $playerGuestCounts.2 green guest(s) and $playerGuestCounts.3 and red guest(s), GreenRedGuestPairPoints should award $expectedPoints points',
    ({ playerGuestCounts, expectedPoints }) => {
      ...
      // When
      const awardedPoints = GreenRedGuestPairPoints(playerMovieMaterial, playerTheaterTileMaterial, playerGuestCounts, 5)
