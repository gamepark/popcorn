...
export class IntergalacticCharacteristics implements MovieCardCharacteristics {
  private readonly actions: MovieAction[] = [MovieAction.PlaceExitZoneGuestInBag, MovieAction.Get2Popcorn, MovieAction.DrawAwardCard, MovieAction.Get4Money]
  ...
  public getBonusAction(theaterTile: TheaterTile): MovieAction | undefined {
    return getBonusAction(theaterTile, 3, MovieAction.Get4Popcorn)
  }
