...
import { isPopcornStartPlayerTurn, isPopcornStartSimultaneousRule, PopcornMove } from '@gamepark/popcorn/material/PopcornMoves'
...
import { BuyingAndAdvertisingPhaseLogDescription } from './BuyingAndAdvertisingPhaseLogDescrioption'
import { CommonLogDescription } from './CommonLogDescription'
import { GlobalStartBuyingPhaseLogComponent } from './components/RuleComponents/GlobalStartBuyingPhaseLogComponent'
import { StartBuyingPhaseLogComponent } from './components/RuleComponents/StartBuyingPhaseLogComponent'
import { StartEndOfRoundPhaseLogComponent } from './components/RuleComponents/StartEndOfRoundPhaseLogComponent'
import { StartFinalEndOfRoundPhaseLogComponent } from './components/RuleComponents/StartFinalEndOfRoundPhaseLogComponent'
import { StartShowingsPhaseLogComponent } from './components/RuleComponents/StartShowingsPhaseLogComponent'
import { EndOfRoundPhaseLogDescription } from './EndOfRoundPhaseLogDescription'
import { FinalEndOfRoundPhaseLogDescription } from './FinalEndOfRoundPhaseLogDescription'
import { ShowingPhaseLogDescription } from './ShowingPhaseLogDescription'
