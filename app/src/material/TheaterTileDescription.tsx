...
class TheaterTileDescription extends TokenDescription<PlayerColor, MaterialType, LocationType, TheaterTileId> {
  ...
  images = {
    ...
    [TheaterTile.TwoSeatRedRed]: twoSeat1Front,
    [TheaterTile.TwoSeatBlueGreen]: twoSeat2Front,
    [TheaterTile.TwoSeatGreenBlue]: twoSeat3Front,
    [TheaterTile.TwoSeatGreen2MoneyMovieAction]: twoSeat4Front,
    [TheaterTile.TwoSeatYellow2PopcornMovieAction]: twoSeat5Front,
    [TheaterTile.TwoSeatBlue2PopcornMovieAction]: twoSeat6Front,
    [TheaterTile.TwoSeatRed2MoneyMovieAction]: twoSeat7Front,
    [TheaterTile.TwoSeatBlue1Popcorn2Money]: twoSeat8Front,
    [TheaterTile.TwoSeatRedBagMovieAction]: twoSeat9Front,
    [TheaterTile.TwoSeatYellowReserve2Money]: twoSeat10Front,
    [TheaterTile.TwoSeatGreenDrawMovieAction]: twoSeat11Front,
    [TheaterTile.TwoSeatYellowYellow]: twoSeat12Front,
