...
const headerBase = css`
  ...
  &::after {
    ...
    background: linear-gradient(90deg,
      ${colors.goldDark} 0%, ${colors.gold} 20%, ${colors.goldLight} 40%,
      ${colors.gold} 60%, ${colors.goldDark} 80%, ${colors.gold} 100%);
...
export const priceTagCss = css`
  ...
  box-shadow: 0 0.1em 0.4em rgba(0,0,0,0.2), inset 0 0.06em 0 rgba(255,255,255,0.2);
`
...
export const seatIconCss = css`
  ...
  &::after {
    content: '';
    position: absolute;
    bottom: -0.22em; left: 0.35em; right: 0.35em;
    height: 0.22em;
...
export const seatNumCss = css`
  ...
  &::after {
    content: '';
    position: absolute;
    bottom: -0.12em; left: 0.15em; right: 0.15em;
    height: 0.12em;
...
export const pawnCss = css`
  ...
  &::before {
    content: '';
    position: absolute;
    top: -0.3em; left: 50%; transform: translateX(-50%);
...
export const scoreRowCss = css`
  ...
  margin-bottom: 0.1em;
  transition: background 0.15s;
  &:hover { background: rgba(212,168,40,0.06); }
`
